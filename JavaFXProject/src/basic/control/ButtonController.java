...
//				System.out.println(observable.getValue().toString());
				if (oldValue != null && newValue != null) {
					System.out.println(oldValue.getUserData()); // 값이 바뀔(다른 토글을 선택할) 때 마다 유저데이터 불러옴
		...
		rad3.setSelected(true); // 이벤트 발생이 없어도 rad3 값이 기본으로 나오도록 설정
		
//		chk1.setOnAction((arg0) -> handleChkAction()); // 람다식
